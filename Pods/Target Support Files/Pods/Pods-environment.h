...
// BAPrayerTimes
#define COCOAPODS_POD_AVAILABLE_BAPrayerTimes
#define COCOAPODS_VERSION_MAJOR_BAPrayerTimes 1
#define COCOAPODS_VERSION_MINOR_BAPrayerTimes 2
#define COCOAPODS_VERSION_PATCH_BAPrayerTimes 0
